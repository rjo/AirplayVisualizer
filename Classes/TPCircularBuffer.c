...
void TPCircularBufferSignal(TPCircularBuffer *buffer) {
...
bool TPCircularBufferInit(TPCircularBuffer *buffer, int length) {
    ...
    while ( true ) {
        ...
        pthread_mutex_init(&buffer->guardMutex,NULL);
        pthread_mutex_init(&buffer->conditionMutex,NULL);
...
void TPCircularBufferCleanup(TPCircularBuffer *buffer) {
    ...
    pthread_mutex_destroy(&buffer->guardMutex);
    pthread_mutex_destroy(&buffer->conditionMutex);
